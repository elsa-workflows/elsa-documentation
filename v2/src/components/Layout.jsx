...
const navigation = [
    ...
    },
    {
        title: 'Installation',
        links: [
            { title: 'Package feeds', href: '/docs/installation/package-feeds' },
            { title: 'Core', href: '/docs/installation/core' },
            { title: 'Server', href: '/docs/installation/server' },
            { title: 'Persistence', href: '/docs/installation/persistence' },
            { title: 'Dashboard', href: '/docs/installation/dashboard' },
            { title: 'Designer', href: '/docs/installation/designer' },
        ],
    },
    {
        title: 'Upgrading',
